...
class NexoMechanicConditionFactory(
    ...
    private fun parseInstruction(instruction: Instruction): NexoMechanicCondition {
        val itemId = instruction[Argument.STRING]
        val location = instruction[Argument.LOCATION]
        return NexoMechanicCondition(itemId, location, mechanicIdProvider)
    }
}
