...
class NexoFurnitureConditionFactory(
    ...
    private fun parseInstruction(instruction: Instruction): NexoFurnitureCondition {
        val itemID= instruction[Argument.STRING]
        val location = instruction[Argument.LOCATION]
        return NexoFurnitureCondition(itemID, location)
    }
}